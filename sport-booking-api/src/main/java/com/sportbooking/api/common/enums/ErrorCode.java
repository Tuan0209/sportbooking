...
public enum ErrorCode {
    ...
    OTP_INVALID(1012, "Mã xác thực không đúng hoặc đã hết hạn"),
    OTP_SEND_FAILED(1013, "Không gửi được mã xác thực, vui lòng thử lại"),
    FIELD_NOT_FOUND(2001, "Field not found"),
    SLOT_ALREADY_BOOKED(2002, "Khung giờ đã được đặt"),
    SLOT_IN_PAST(2005, "Khung giờ đã qua, không thể đặt"),
    ...
    REFUND_TOO_LATE(3004, "Chỉ được yêu cầu hoàn tiền trước giờ bắt đầu ít nhất 2 tiếng"),
